...
class Mtamu extends CI_Model {
  ...
  public function validation($mode){
    ...
    if($mode == "save"){
      ...
      $this->form_validation->set_rules('input_idcard', 'Idcard', 'required');
    }else if($mode == "update"){
      ...
      $this->form_validation->set_rules('edit_idcard', 'Idcard', 'required');
    }
  ...
  public function save(){
    $data = array(
      ...
      "idcard" => $this->input->post('input_idcard'),
  ...
  public function edit($id){
    $data = array(
      ...
      "idcard" => $this->input->post('edit_idcard'),
