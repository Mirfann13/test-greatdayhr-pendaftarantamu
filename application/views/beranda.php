...
<head>
	...
	<title>Beranda | Pendaftaran Tamu</title>
				...
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.html">
							...
							<span style="color:black;font-size:18px;">Pendaftaran Tamu</span>
						</a>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<span class="weight-500 font-20 block text-center txt-danger">Jumlah Tamu</span>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form>
						...
						<div class="form-group">
							<label class="control-label mb-10" for="idcard">Id Card</label>
							<input type="number" class="form-control" name="input_idcard" id="idcard" placeholder="Masukkan idcard">
						</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form>
						...
						<div class="form-group">
							<label class="control-label mb-10" for="edit_idcard">Id Card</label>
							<input type="number" class="form-control" name="edit_idcard" id="edit_idcard" placeholder="Masukkan Idcard">
						</div>
	...
	<script>
		...
		$(document).ready(function () {
					...
					success: function (data) {
						...
						for (i = 0; i < data.length; i++) {
							html += '<tr id="' + data[i].id_tamu + '">' +
								...
								'<td>' + data[i].waktu + '</td>' +
								'<td>' +
								'<button class="btn btn-xs btn-primary" style="padding-left: 10px;padding-right: 10px;" data-toggle="modal" data-target="#form-edit" id="btn-edit" data-id="' + data[i].id_tamu + '" data-nama="' + data[i].nama + '" data-jk="' + data[i].jenis_kelamin + '" data-jk="' + data[i].jenis_kelamin + '" data-alamat="' + data[i].alamat + '" data-idcard="' + data[i].idcard + '"> <i class="fa fa-pencil"></i></button> ' +
			...
			$('#btn-tambah').click(function () {
				var arg = {
					resultFunction: function (result) {
						...
						// document.getElementById("input_idcard").innerHTML = array_tamu[3];
			...
			$('#form-tambah').on('hidden.bs.modal', function (e) { // Ketika Modal Dialog di Close / tertutup
				$('#form-tambah #nama, #form-tambah #alamat, #form-tambah #idcard').val('') // Clear inputan menjadi kosong
			})
		})
